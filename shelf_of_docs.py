...
def secretary_program_start():
    ...
    while True:
        ...
        if user_command == 'p':
            owner_name = get_doc_owner_name(input('Введите номер документа - '))
            ...
            directory_number = get_doc_shelf(input('Введите номер документа - '))
            ...
            doc_number, deleted = delete_doc(input('Введите номер документа - '))
            if deleted:
